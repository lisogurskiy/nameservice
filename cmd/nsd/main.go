...
import (
	...
	app "github.com/lisogurskiy/nameservice"
...
// Sets the folder where the application data and configuration will be stored
...
// Initializes all files for Tendermint and application
...
// Allows users to add accounts to the genesis file
